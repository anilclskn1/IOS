...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    override func viewWillAppear(_ animated: Bool) {
        NotificationCenter.default.addObserver(self, selector: #selector(getData), name: Notification.Name(rawValue:"newPost"), object: nil)
    }
    ...
    @objc func getData() {
        ...
        do {
            ...
            for result in results as! [NSManagedObject] {
                if let name = result.value(forKey: "artName") as? String {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toDetailsVC" {
            ...
            destinationVC?.selectedUUID = chosenId
        }
    }
